        ...
        <section className='max-w-7xl mx-auto'>
            <div>
                ...
                <p className='mt-2 text-[#fdf2ff] text-[16px] max-w-[500px]'>
                    Browse through or add to a gallery of imaginative and visually stunning images fabricated using DALL-E AI
                </p>
            </div>
            ...
            <div className='mt-10'>
                {loading ? (
                    ...
                    <>
                        {searchText && (
                            <h2 className='font-medium text-[#fdf2ff] text-xl mb-3'>
